...
const validationSchema = yup.object({
  name: yup
    ...
    .min(4, "Property name should be of minimum 4 characters length")
    .required("Property name is required"),
  address: yup
    .string("Enter Property address")
    .min(10, "Property address should be of minimum 10 characters length")
    .required("Property address is required"),
  desc: yup
    .string("Enter Property description")
    .min(20, "Property description should be of minimum 20 characters length")
    .required("Property description is required"),
  rent: yup.number().required("Rent price is required"),
  preferenceItem: yup
    .string("Enter your Preferences")
    .min(4, "Property description should be of minimum 4 characters length")
...
const RoomDetails = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      console.log(values);
      dispatch(actionCreator.postRoomAction(values));
    },
  });
          ...
          <Box>
            ...
            <Box>
              <TextField
                ...
                onChange={formik.handleChange}
                error={formik.touched.preferences && Boolean(formik.errors.preferences)}
                helperText={formik.touched.preferences && formik.errors.preferences}
